...
def fromParameters(pos, neg, fname_param, new_bs=False, old_prop=True, topo=None, auto_factor=False, experimental_setup = {'ccd_dist': 18e-2, 'energy': 779.5, 'px_size' : 20e-6}):
    ...
    return(holoN, factor, center, bs_diam, roi, prop_dist, phase,dx,dy)
...
def save_parameters(fname, recon, factor, center, bs_diam, prop_dist, phase, dx, dy, roi, image_numbers, comment = '', topo = None):
    '''
